...
public class CameraFollow : MonoBehaviour {
	...
	Vector3 _startTransformHeading;

    void Start(){
		initialCameraPosition = gameObject.transform.position;
		initialCarPosition = carTransform.position;
		absoluteInitCameraPosition = initialCameraPosition - initialCarPosition;
		_startTransformHeading = initialCameraPosition - initialCarPosition;
	...
	void FixedUpdate()
	{
        ...
        var heading = initialCameraPosition - carTransform.position;
		if (heading.sqrMagnitude < _startTransformHeading.sqrMagnitude)
		{
