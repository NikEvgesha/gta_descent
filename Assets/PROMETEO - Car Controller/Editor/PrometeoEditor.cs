...
public class PrometeoEditor : Editor{
  ...
  private SerializedProperty _pointForseLeft;
  private SerializedProperty _pointForseRight;
  private SerializedProperty _forseRotate;
    //
    //
    //WHEELS VARIABLES
    //
  ...
  private void OnEnable(){
    ...
    _forseRotate = SO.FindProperty("_forseRotate");
        _pointForseLeft = SO.FindProperty("_pointForseLeft");
        _pointForseRight = SO.FindProperty("_pointForseRight");
  ...
  public override void OnInspectorGUI(){
    ...
    EditorGUILayout.PropertyField(bodyMassCenter, new GUIContent("Mass Center of Car: "));
        EditorGUILayout.PropertyField(_forseRotate, new GUIContent("Forse Rotate: "));
        EditorGUILayout.PropertyField(_pointForseLeft, new GUIContent("Point Forse Left: "));
        EditorGUILayout.PropertyField(_pointForseRight, new GUIContent("Point Forse Right: "));
